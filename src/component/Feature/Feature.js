                    ...
                    <div className="feature_rap">
                        <div className="f_box">
                            <div className="feature_box feature_first_box ">
                                <div className="feature_list" style={{ marginTop: "6rem" }}>
                                    <div className="row">
                                        <div className="col-md-3 coll-11">
                                        ...
                                        <div className="col-md-9 col-11">
                                            <p className="feature_list_text ms-lg-5 mt-4">
                                                チャット形式のアンケートで, <br />
                            ...
                            <div className="feature_small_box feature_third_box">
                                <div className="d-flex justify-content-center align-items-center mt-4">
                                    <img className='feature_box3_img img-fluid me-4' src="/images/logo.png" alt="Logo " />
